        ...
        <div className="MainHeaders">
          ...
          <ul className="HorizontalCards">
            ...
            <a href="https://www.facebook.com/">
              <img width="50px" src={require('./images/facebook_icon.png')} alt="facebook"/>
            </a>
            <a href="https://www.instagram.com/">
              <img width="50px" src={require('./images/Instagram_icon.png')} alt="insta"/>
            </a>
            <a href="https://twitter.com/">
              <img width="50px" src={require('./images/twitter_icon.png')} alt="x"/>
            </a>
          </ul>
        </div>
      </div>
